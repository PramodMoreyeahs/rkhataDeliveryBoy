...
import in.moreyeahs.livspace.delivery.databinding.FragmentHistoryBinding;
import in.moreyeahs.livspace.delivery.model.HistoryDataModel;
...
import in.moreyeahs.livspace.delivery.viewmodels.HistoryAdapterViewModel;
import in.moreyeahs.livspace.delivery.viewmodels.HistoryViewModel;
import in.moreyeahs.livspace.delivery.views.adapter.HistoryIssuanceDetailAdapter;
...
public class HistoryFragment extends Fragment {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
         ...
         * ***/
        historyViewModel.getOrderDetailsData().observe(this, apiResponseObj -> {
