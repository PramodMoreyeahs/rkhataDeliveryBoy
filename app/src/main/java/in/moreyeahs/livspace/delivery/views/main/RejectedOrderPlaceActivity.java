...
public class RejectedOrderPlaceActivity extends AppCompatActivity implements CropImageView.OnSetImageUriCompleteListener, OrderchequeimageListener, MultiMposListener {
    ...
    private Spinner spStatus, spComment;
    ...
    private ImageView checkPhotoCapture;
    ...
    double amount = 0.0, hdfcamount = 0.0, epayamount = 0.0, grossAmt, cashAmt = 0.0, gullakamount = 0.0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding.setOrderPlacedListener(new OrderPlacedListener() {
            ...
            public void checkLayHideUnHideClicked() {
                if (ischeque) {
                    ...
                    if (mBinding.checkDetails.getVisibility() == View.VISIBLE) {
                    ...
                    if (msg != null && !(msg.equalsIgnoreCase(""))) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(RejectedOrderPlaceActivity.this)
                                .setCancelable(true)
                                .setMessage(msg);
                        builder.show();
                    } else {
            ...
            public void checkUriHideUnHideClicked() {
                if (mBinding.UTRDetail.getVisibility() == View.VISIBLE) {
                    mBinding.UTRDetail.setVisibility(View.GONE);
                } else {
            ...
            public void updateBtnClicked() {
                if (mBinding.spStatus.getSelectedItemPosition() == 0) {
                    Utils.setToast(RejectedOrderPlaceActivity.this, getString(R.string.choose_status_and_comment));
            ...
            public void paymentBtnClicked() {
                ...
                if (!Utils.checkInternetConnection(RejectedOrderPlaceActivity.this)) {
                    Utils.setToast(RejectedOrderPlaceActivity.this, getResources().getString(R.string.network_error));
                } else {
                    // getting et value
                    ...
                    if (sCaseAmount.length() > 0) {
                        if (Integer.valueOf(sCaseAmount) > 200000) {
                            Utils.setToast(RejectedOrderPlaceActivity.this, "Cash Amount should not Be Greater than 2 lakh");
                        } else {
                            paymentThrough = "cash";
                                ...
                                if (amount == grossAmt) {
                                    if (sChequeAmount != "" && sChequeAmount.length() > 0 && !(sChequeAmount.equalsIgnoreCase("0"))) {
                                        ...
                                        if (Integer.valueOf(sChequeAmount) > chequeLimit) {
                                            Utils.setToast(RejectedOrderPlaceActivity.this, "Cheque Amount should not be greater than " + chequeLimit);
                                        } else {
                                                ...
                                                if (chequePaymentList.size() > 0) {
                                                    ...
                                                    for (int i = 0; i < chequePaymentList.size(); i++) {
                                                        if (!newList.contains(chequePaymentList.get(i).getTransId())) {
                                                            ...
                                                            isboolean = false;
                                                            Utils.setToast(RejectedOrderPlaceActivity.this, "Cheque Number should not be same");
                                                            break;
                                                        }
                                                        if (chequePaymentList.get(i).getAmount() == 0) {
                                                            Utils.setToast(RejectedOrderPlaceActivity.this, "Enter Cheque Amount");
                                                            isboolean = false;
                                                            break;
                                                            ...
                                                            isboolean = false;
                                                            Utils.setToast(RejectedOrderPlaceActivity.this, getString(R.string.plz_select_Bank_name));
                                                            break;
                                                        } else if (chequePaymentList.get(i).getChequeImageUrl() == null|| chequePaymentList.get(i).getChequeImageUrl().equalsIgnoreCase("") ) {
                                                            isboolean = false;
                                                            Utils.setToast(RejectedOrderPlaceActivity.this, getString(R.string.plz_upload_check_images));
                                                            break;

                                                        } else if (chequePaymentList.get(i).getPaymentDate() == null|| chequePaymentList.get(i).getPaymentDate().equalsIgnoreCase("")) {
                                                            isboolean = false;
                                                            Utils.setToast(RejectedOrderPlaceActivity.this, getString(R.string.enter_check_date));
                                                            break;
                                                        } else if (chequePaymentList.get(i).getTransId() == null|| chequePaymentList.get(i).getTransId().equalsIgnoreCase("")) {
                                                            isboolean = false;
                                                            Utils.setToast(RejectedOrderPlaceActivity.this, getString(R.string.plz_enter_chequeno));
                                                            break;
                                                        }else {
                                                            isboolean = true;
                                                        }
                                                    ...
                                                    if (isboolean) {
                                                        ...
                                                        for (int i = 0; i < mposPaymentList.size(); i++) {
                                                            ...
                                                            if (!newlist.contains(mposPaymentList.get(i).getTransId())) {
                                                                ...
                                                                ismposboolean = false;
                                                                Utils.setToast(RejectedOrderPlaceActivity.this, "Mpos Number should not be same");
                                                                break;
                                                            }
                                                            if (mposPaymentList.get(i).getTransId() == null || mposPaymentList.get(i).getTransId().equalsIgnoreCase("")) {
                                                                ismposboolean = false;
                                                                Utils.setToast(RejectedOrderPlaceActivity.this, getString(R.string.enter_reference_id));
                                                                break;
                                                            } else if (mposPaymentList.get(i).getTransId().length() < 8) {
                                                                ismposboolean = false;
                                                                Utils.setToast(RejectedOrderPlaceActivity.this, getString(R.string.enter_reference_mpos_id));
                                                                break;
                                                            } else if (mposPaymentList.get(i).getAmount() == 0) {
                                                                ismposboolean = false;
                                                                Utils.setToast(RejectedOrderPlaceActivity.this, "Please Enter Mpos Amount");
                                                                break;
                                                            } else {
                                                                ismposboolean = true;
                                                            }
                                    ...
                                    Utils.setToast(RejectedOrderPlaceActivity.this, getString(R.string.enter_total_amt));
                                }
            ...
            public void onlinePaymentBtnClicked() {
                if (spStatus.getSelectedItem().toString().equalsIgnoreCase("select")) {
                    ...
                    if (lat != 0 && lg != 0) {
                        GPSTracker gpsTracker = new GPSTracker(RejectedOrderPlaceActivity.this);
                        ...
                        if (distance <= 100) {
                            ...
                            Intent i = new Intent(RejectedOrderPlaceActivity.this, ScanCodeActivity.class);
        ...
        orderPlaceViewModel.getDeclineOrderDetail().observe(this, apiResponse -> {
            if (apiResponse != null) {
                consumeResponseDeclineOrder(apiResponse);
            }
        });
        ...
        orderPlaceViewModel.getDeclineOrderPlacedResponseData().observe(this, apiResponse -> {
            if (apiResponse != null) {
                consumeResponseForDeclineOrderPlace(apiResponse);
            }
        });
 ...
 * **/
    ...
    private void CallAPI() {
        if (!Utils.checkInternetConnection(this)) {
            ...
            orderPlaceViewModel.hitDeclineOrderDetailAPI(orderId);
            ...
            if (!response.isJsonNull()) {
                ...
                try {
                    ...
                    if (bankNameModel.isStatus()) {
                        ...
                        adapter = new MultipleChequeAdapter(RejectedOrderPlaceActivity.this, BankNameList, chequePaymentList, orderId, this);
    ...
    private void checkFieldsForEmptyValues() {
        try {
            ...
            if (sCaseAmount != "" && sCaseAmount.length() > 0) {
                cashAmt = Double.parseDouble(sCaseAmount);
            ...
            cashAmt = (grossAmt - (hdfcamount + epayamount + gullakamount + chequeAmt + upiAmt));
            if (cashAmt > 0||cashAmt==0) {
                etCaseAmount.removeTextChangedListener(mTextWatcher);
                etCaseAmount.setText("" +(int) cashAmt);
                etCaseAmount.addTextChangedListener(mTextWatcher);
                double totalAmt = cashAmt + chequeAmt + upiAmt;
                amount = hdfcamount + epayamount + gullakamount + totalAmt;
                mBinding.tvPaidAmount.setText("" + amount);
    ...
    private void WSCallforOrderPlace(boolean paymentType) {
        if (isOtpVerified) {
            try {
                SharePrefs.getInstance(RejectedOrderPlaceActivity.this).putInt(SharePrefs.DELIVERY_ISSUANCE_ID, deliveryIssuanceId);
            ...
            spStatus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (sSpStatus.equalsIgnoreCase("Delivery Canceled") || sSpStatus.equalsIgnoreCase("Delivery Redispatch")) {
                        ...
                        ((TextView) v).setTextColor(ContextCompat.getColor(RejectedOrderPlaceActivity.this, R.color.green));
                        hideShowView(true, sSpStatus);
                        return;
                    } else if (trupay.equalsIgnoreCase("true")) {
                        Log.e("Fragment", "Truepay");
                        if (sSpStatus.equalsIgnoreCase("Delivered")) {
                            View v = spStatus.getSelectedView();
                            ((TextView) v).setTextColor(ContextCompat.getColor(RejectedOrderPlaceActivity.this, R.color.green));
                            ArrayAdapter commentAdapter = ArrayAdapter.createFromResource(RejectedOrderPlaceActivity.this, R.array.delivered_comment, android.R.layout.simple_spinner_dropdown_item);
                            spComment.setAdapter(commentAdapter);
                        } else {
                            ArrayAdapter commentAdapter = ArrayAdapter.createFromResource(RejectedOrderPlaceActivity.this, R.array.comment_delivery_redispatch, android.R.layout.simple_spinner_dropdown_item);
                            spComment.setAdapter(commentAdapter);
                        }
                        return;
    ...
    private void consumeResponseDeclineOrder(ApiResponse apiResponse) {
        switch (apiResponse.status) {
            case LOADING:
                mBinding.proRelatedItem.setVisibility(View.VISIBLE);
                break;
            ...
            case SUCCESS:
                mBinding.proRelatedItem.setVisibility(View.GONE);
                renderSuccessResponseDeclineOrder(apiResponse.data);
                break;
    ...
    private void consumeResponseForDeclineOrderPlace(ApiResponse apiResponse) {
        switch (apiResponse.status) {
            case LOADING:
                progressDialog.show();
                break;
            case SUCCESS:
                ...
                renderSuccessResponseForDeclineOrderPlaced(apiResponse.data);
                break;
            case ERROR:
                progressDialog.dismiss();
                Utils.setToast(this, getResources().getString(R.string.errorString));
    ...
    private void renderSuccessResponseDeclineOrder(JsonElement response) {
        dueAmount=0.0;
        hdfcamount = 0.0;
        cashAmt = 0.0;
        epayamount = 0.0;
                    ...
                    if (orderDetailsModel.isStatus()) {
                        ...
                        for (int i = 0; i < orderDetailsModel.getPayment().size(); i++) {
                            if (orderDetailsModel.getPayment().get(i).getPaymentFrom().equalsIgnoreCase("Cash")) {
                                ...
                                // dueAmount = orderDetailsModel.getPayment().get(i).getAmount();
                        ...
                        } else if ((hdfcamount + epayamount + gullakamount) != grossAmt && orderDetailsModel.getOrderDispatchedObj().getRedispatchcount() == 5) {
    ...
    private void renderSuccessResponseForDeclineOrderPlaced(JsonElement response) {
        if (Utils.isJSONValid(response.toString())) {
            if (!response.isJsonNull()) {
                mBinding.proRelatedItem.setVisibility(View.GONE);
    ...
    private void UpdateAPICall(boolean paymentType) {
        if (isOtpVerified) {
            ...
            if (!Utils.checkInternetConnection(this)) {
                ...
                orderPlaceViewModel.hitDeclineOrderPlacedApi(orderPlacedModel);
            }
        } else {
            orderPlaceViewModel.hitOrderOTPExist(orderId, spStatus.getSelectedItem().toString(), spComment.getSelectedItem().toString());
        }
    ...
    private void onCropImageClick() {
        mBinding.cropBtn.setOnClickListener(view -> {
            ...
            //  checkPhotoCapture.setImageBitmap(cropped);
        ...
        public void onNext(String response) {
            try {
                ...
                if (response != null) {
                    ...
                    Toast.makeText(RejectedOrderPlaceActivity.this, "Image Not Uploaded", Toast.LENGTH_SHORT).show();
   ...
   /* private void uploadImagePath() {
            ...
            Ion.with(this)
                    ...
                    .setCallback((e, result) -> {
                        if (result != null) {
                            ...
                            adapter.notifyDataSetChanged();
                            Log.e("Success", ChequeimgUrl);
                            // Picasso.with(this).load(ChequeimgUrl).into(this.checkPhotoCapture);
                            //  Glide.with(this).load(BuildConfig.apiEndpoint + result.replace("\"", "")).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).into(checkPhotoCapture);
                            Toast.makeText(this, "Image Uploaded", Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
                        } else {
                            Log.e("Failed", "Failed ####  " + result);
                            Picasso.get().load(R.drawable.ic_add_image_icon).placeholder(R.drawable.ic_add_image_icon).into(this.chequeimage);
    ...
    private void setActionBarConfiguration() {
        ...
        mBinding.tvOrderno.setText(RejectedOrderPlaceActivity.this.getString(R.string.OrderID) + orderId);
