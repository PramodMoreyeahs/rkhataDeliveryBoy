...
public class MyTaskViewModel extends ViewModel {
     ...
     * My task API call
     * */
    public void hitMyTaskApi(int DeliveryIssuanceId, String mobileNumber) {
        DisposableObserver<JsonElement> observerDes = RestClient.getInstance().getService().getMyTaskData(DeliveryIssuanceId, mobileNumber)
