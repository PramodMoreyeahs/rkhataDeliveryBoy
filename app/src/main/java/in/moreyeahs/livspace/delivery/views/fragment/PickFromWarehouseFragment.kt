...
import kotlinx.android.synthetic.main.fragment_pick_from_warehouse.*
 ...
 */
class PickFromWarehouseFragment : Fragment(), `in`.moreyeahs.livspace.delivery.listener.ButtonClick {
    private lateinit var activity: Activity
    private lateinit var viewModel: `in`.moreyeahs.livspace.delivery.viewmodels.PickFromWareModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_pick_from_warehouse, container, false)
    }

    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)
        viewModel = ViewModelProviders.of(this).get(`in`.moreyeahs.livspace.delivery.viewmodels.PickFromWareModel::class.java)

        recyclerPickFromWar.layoutManager = LinearLayoutManager(activity)
        ...
        try {
            if (element != null) {
                ...
                if (array.length() > 0) {
                    ...
                    recyclerPickFromWar.adapter = adapter
                } else {
                    tvEmpty.visibility = View.VISIBLE
                }
            }
