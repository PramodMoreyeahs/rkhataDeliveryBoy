...
import in.moreyeahs.livspace.delivery.databinding.OnlinePayAdapterBinding;
...
public class OnlinepaymentAdapter extends RecyclerView.Adapter<OnlinepaymentAdapter.ViewHolder> {
    ...
    public  OnlinepaymentAdapter(Context context, ArrayList<PostOnlineCollectionModel> onlineModellist) {
