...
public class MyItemDetailsAdapter extends RecyclerView.Adapter<MyItemDetailsAdapter.ViewHolder> {

    private Context context;
    private ArrayList<OrderItemDetails> itemList;
    private LayoutInflater layoutInflater;
    public MyItemDetailsAdapter(Context context, ArrayList<OrderItemDetails> itemList) {
        this.context = context;
        this.itemList = itemList;
    }
    public void setItemDetailsList(ArrayList<OrderItemDetails> itemList) {
        this.itemList = itemList;
    ...
    @Override
    public void onBindViewHolder(@NonNull MyItemDetailsAdapter.ViewHolder viewHolder, int i) {
        try {
            /**
             * set value
             * ***/
            OrderItemDetails orderItemDetails = itemList.get(i);
           ...
           // String sPRICE = new DecimalFormat("##.##").format(orderItemDetails.getPrice());
            ...
            info.setPrice(String.valueOf(orderItemDetails.getUnitprice()));
