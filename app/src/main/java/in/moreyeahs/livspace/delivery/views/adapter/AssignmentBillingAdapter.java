...
import in.moreyeahs.livspace.delivery.databinding.ItemAssignmentBillingBinding;
import in.moreyeahs.livspace.delivery.model.OrderModel;
import in.moreyeahs.livspace.delivery.utilities.DateUtils;
import in.moreyeahs.livspace.delivery.viewmodels.OrderAssignmentViewModel;
...
public class AssignmentBillingAdapter extends RecyclerView.Adapter<AssignmentBillingAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull AssignmentBillingAdapter.ViewHolder viewHolder, int i) {
        ...
        if (orderDelMastAssignment.getStatus().equalsIgnoreCase("Delivered")) {
            ...
            viewHolder.statusTV.setTextColor(Color.parseColor("#b5a667"));
            viewHolder.statusTV.setText(orderDelMastAssignment.getStatus());
        }
